...
\begin{tikzpicture}
 ...
 \node [box, right of=2, node distance=10em] (3) {\small{Prepare data matrix from database}};
 \node [cyl, right of=3, node distance=8em, text width=1.3cm, text height=.2cm] (4) {\small{V \& Co SPND Database}};
